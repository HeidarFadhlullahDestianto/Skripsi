...
return new class extends Migration {
    public function up(): void
    {
        Schema::create('saved_schedules', function (Blueprint $table) {
            ...
            $table->foreignId('rule_latihan_id')
                  ->constrained('rule_latihans')
                  ->onDelete('cascade');
            ...
            // HARI + LATIHAN (DIGABUNG)
            $table->string('hari_1')->nullable();
            $table->string('latihan_1')->nullable();

            $table->string('hari_2')->nullable();
            $table->string('latihan_2')->nullable();

            $table->string('hari_3')->nullable();
            $table->string('latihan_3')->nullable();

            $table->string('hari_4')->nullable();
            $table->string('latihan_4')->nullable();

            $table->string('hari_5')->nullable();
            $table->string('latihan_5')->nullable();

            $table->string('hari_6')->nullable();
            $table->string('latihan_6')->nullable();

            $table->string('hari_7')->nullable();
            $table->string('latihan_7')->nullable();
